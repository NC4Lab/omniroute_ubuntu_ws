...
class RatDetector:
    ...
    def did_rat_body_move_to(self, new_chamber):
        ...
        if current_chamber_x == new_chamber_x or current_chamber_y == new_chamber_y:
            ...
            if self.dist(self.harness_x, self.harness_y, current_chamber_x, current_chamber_y) >= (self.MazeDim.chamber_wd * (math.sqrt(2) + 0.37)) and self.is_rat_head_in_chamber(new_chamber):
                return True
