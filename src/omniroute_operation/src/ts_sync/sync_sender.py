...
class SyncSender:
    ...
    def event_callback(self, event):
        ...
        if event.event == 'start_optitrack_sync':
            self.EsmaCom.writeEcatMessage(EsmacatCom.MessageType.SET_OPTITRACK_SYNC_PIN, 1)
            ...
            self.EsmaCom.writeEcatMessage(EsmacatCom.MessageType.SET_OPTITRACK_SYNC_PIN, 0)
