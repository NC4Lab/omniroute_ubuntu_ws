...
#         r = rospy.Rate(30)
#         MazeDB.printMsg(
#             'INFO', "Initialzed gantry_operation_node")
...
#             MazeDB.printMsg(
#                 'DEBUG', "Move command received: target(%0.2f, %0.2f)", self.target_x, self.target_y)
...
#             self.gantry_mode = GantryState.MOVE_TO_TARGET
#             self.move_gantry_rel(0, 0)
#             MazeDB.printMsg('DEBUG', "Move to chamber command received: chamber(%d) target(%0.2f, %0.2f)",
#                             chamber_num, self.target_x, self.target_y)

#         elif msg.cmd == "TRACK_HARNESS":
#             MazeDB.printMsg(
#                 'DEBUG', "Track Hhrness command received")
#             self.gantry_mode = GantryState.TRACK_HARNESS

#         elif msg.cmd == "IDLE":
#             MazeDB.printMsg(
#                 'DEBUG', "Idle command received")
#             self.gantry_mode = GantryState.IDLE
...
#             MazeDB.printMsg(
#                 'DEBUG', "Reward command received: duration(%d)", duration)
#             self.EsmaCom.writeEcatMessage(
