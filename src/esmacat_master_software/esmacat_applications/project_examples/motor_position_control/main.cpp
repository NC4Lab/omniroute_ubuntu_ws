/** @file
 * @brief This file contains the main program for the example project to control the position
 * of a motor using Esmacat slaves */
/*****************************************************************************************
 * INCLUDES
 ****************************************************************************************/
#include <iostream>
 ...
 *        primary real-time loop for your application for the Motor Driver module of Esmacat.
 * @return
 */
