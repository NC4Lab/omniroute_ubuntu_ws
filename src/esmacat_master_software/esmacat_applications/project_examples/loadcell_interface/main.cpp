/** @file
 * @brief This file contains the main program for the Esmacat Loadcell Interface slave
 * example project */
/*****************************************************************************************
 * INCLUDES
 ****************************************************************************************/
...
int main()
{
    ...
    // select an ethernet adapter (the slave) you'd like to communicate with over EtherCAT
